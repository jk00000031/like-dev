...
<template>
  <section class="h-[calc(100vh-164px)] container mx-auto py-40 space-x-20">
    <div class="w-64 mx-auto">
      <NTabs type="segment">
        <NTabPane name="default" tab="账号登录">
          <NForm ref="accountFormRef" :model="accountFields" :rules="accountRules" label-placement="left" class="pt-2">
            ...
            <NFormItem>
              <div class="flex-grow">
                <NButton type="primary" block round :loading="submiting" @click="handleAccountSubmit"> 登录 </NButton>
        ...
        <NTabPane name="sms" tab="短信登录">
          <NForm label-placement="left" class="pt-2">
            <NFormItem>
              <NInput placeholder="请输入手机号" />
            </NFormItem>
            <NFormItem>
              <NInputGroup>
                <NInput placeholder="短信验证码" />
                <NInputGroupLabel>获取验证码</NInputGroupLabel>
              </NInputGroup>
            </NFormItem>
            <NFormItem>
              <NButton type="primary" block round>登录</NButton>
            </NFormItem>
          </NForm>
        </NTabPane>
      </NTabs>
